...
export const EventHandler = observer((
  ...
  const {events: {activeEvent}, tick} = baseGame();
...
const DialogDefault = ({children}: { children: ReactNode }) => (
  <div
    className="fixed left-[50%] top-[50%] grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-6 shadow-lg duration-200 rounded-lg">
    {children}
  </div>
)
