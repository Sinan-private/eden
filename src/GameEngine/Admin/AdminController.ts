...
import {areObjectsEqual} from "@/GameEngine/Admin/equalityChecks.ts";
import {updateResourceKeys, updateResources} from "@/GameEngine/ResourceEngine/server/api/apiService.ts";
import {ResourceClass, ResourceKeys, ResourceEngineClass, ResourceTypes} from "src/GameEngine/ResourceEngine";
import {AdminResourceController} from "@/GameEngine/Admin/AdminResourceController.ts";
import {ResourceCloneProps} from "@/GameEngine/ResourceEngine/ResourceHandler/genericTypes.ts";
...
export class AdminController {
  ...
  public cloneResourceStore: ResourceEngineClass;
  ...
  constructor(
    private originalResourceStore: ResourceEngineClass,
  ...
  public static getInstance(
    originalResourceStore?: ResourceEngineClass,
    keys?: ResourceKeys[],
    types?: ResourceTypes[],
    config?: AdminControllerCreationProps
  ): AdminController {
  ...
  public onOpenAdminPanel = () => this.show_admin_panel = true;
  ...
  public onOpenDebugPanel = () => this.show_debug_panel = true;
  public onCloseDebugPanel = () => this.show_debug_panel = false;
